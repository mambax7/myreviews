...
mainheader();
echo "<div border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\"><big><b>"._MD_RECOMMENDLIST."</b></big><br><br></div>";
...
while(list($cid,$ctitle)=$xoopsDB->fetchRow($result)){
	...
	$query = "SELECT lid, cid, title, hits, rating, votes FROM ".$xoopsDB->prefix("myReviews_downloads")." WHERE status>0 AND rating > 0 AND recommendit=1 AND (cid=$cid";
